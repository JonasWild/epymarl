...
# config = "--config=mappo"
# env_config = "--env-config=gymmatest"
...
def _build_config_dict(p_params, p_default_config_filename, p_custom_env_config_filename):
    ...
    customEnvArgs = {}
    # Get the defaults from default.yaml
    with open(os.path.join(os.path.dirname(__file__), "config", f"customEnv/{p_custom_env_config_filename}.yaml"), "r") as f:
        try:
...
if __name__ == '__main__':
    ...
    default_config_filenames = [
        ("multiTest", "sc2smaller_corridor_spawn_behind_2zealot_vs_8zerg", "test_1"),
        ("multiTest", "sc2smaller_corridor_spawn_behind_2zealot_vs_8zerg", "test_2"),
        ("multiTest", "sc2smaller_corridor_spawn_behind_2zealot_vs_8zerg", "test_3"),
        ("multiTest", "sc2smaller_corridor_spawn_behind_2zealot_vs_8zerg", "test_4"),
        ("multiTest", "sc2smaller_corridor_spawn_behind_2zealot_vs_8zerg_neg", "test_1"),
        ("multiTest", "sc2smaller_corridor_spawn_behind_2zealot_vs_8zerg_neg", "test_2"),
        ("multiTest", "sc2smaller_corridor_spawn_behind_2zealot_vs_8zerg_neg", "test_3"),
        ("multiTest", "sc2smaller_corridor_spawn_behind_2zealot_vs_8zerg_neg", "test_4"),
        #("multiTest", "sc2smaller_corridor_spawn_behind_2zealot_vs_8zerg", "test_5"),
    ]

    for index, (default_config_filename, env_config_filename, custom_env_config_filename) in enumerate(default_config_filenames):
