...
class Logger:
    ...
    def log_heatmap(self, heatmaps):
        if self.use_tb and heatmaps is not None:
            for heatmap in heatmaps:
                if self.heatmap_steps_dict.get(heatmap.name) is None:
                    self.heatmap_steps_dict[heatmap.name] = 0
